...
and their solution to the Sorites.\footnote{Contextualists exploit this
  ...
  Press, 2010), 275--76,
  \url{https://doi.org/10.1093/acprof:oso/9780199570386.003.0016}.
  ...
  member $\mathbf{n}$. This is because, the shift of context $C$ into $C'$,
  enables cases where `$\mathbf{n}$ is short' is true (in $C$) but `$\mathbf{n}+1$ is short' is false (in $C'$). See J. Åkerman, "Contextualist Theories of Vagueness,"
  \textit{Philosophy Compass} 7 (2012): 470--75, \url{https://doi.org/10.1111/j.1747-9991.2012.00495.x}.}
